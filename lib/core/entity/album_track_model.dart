class AlbumTrackModel {
  ...
  AlbumTrackModel.fromJson(Map<String, dynamic> json) {
    href = json['href'];
    if (json['items'] != null) {
      items = <AlbumTrackItems>[];
      json['items'].forEach((v) {
        items!.add(new AlbumTrackItems.fromJson(v));
      });
    }
    limit = json['limit'];
    next = json['next'];
...
class AlbumTrackItems {
  ...
  AlbumTrackItems.fromJson(Map<String, dynamic> json) {
